...
public class Order {
  ...
  public int m_parentId; // Parent order Id, to associate Auto STP or TRAIL orders with the original
                         // order.
  public boolean m_blockOrder;
  public boolean m_sweepToFill;
  public int m_displaySize;
  public int m_triggerMethod; // 0=Default, 1=Double_Bid_Ask, 2=Last, 3=Double_Last, 4=Bid_Ask,
  ...
  public String m_rule80A; // Individual = 'I', Agency = 'A', AgentOtherMember = 'W', IndividualPTIA
  ...
  public int m_shortSaleSlot; // 1 if you hold the shares, 2 if they will be delivered from
  ...
  public boolean equals(Object p_other) {
    ...
    if (m_orderId != l_theOther.m_orderId || m_clientId != l_theOther.m_clientId
        || m_totalQuantity != l_theOther.m_totalQuantity || m_lmtPrice != l_theOther.m_lmtPrice
        || m_auxPrice != l_theOther.m_auxPrice || m_ocaType != l_theOther.m_ocaType
        ...
        || m_triggerMethod != l_theOther.m_triggerMethod || m_outsideRth != l_theOther.m_outsideRth
        ...
        || m_trailingPercent != l_theOther.m_trailingPercent || m_origin != l_theOther.m_origin
        || m_shortSaleSlot != l_theOther.m_shortSaleSlot
        || m_discretionaryAmt != l_theOther.m_discretionaryAmt
        || m_eTradeOnly != l_theOther.m_eTradeOnly || m_firmQuoteOnly != l_theOther.m_firmQuoteOnly
        ...
        || m_whatIf != l_theOther.m_whatIf || m_notHeld != l_theOther.m_notHeld
    ...
    if (Util.StringCompare(m_action, l_theOther.m_action) != 0
        ...
        || Util.StringCompare(m_deltaNeutralClearingAccount,
            l_theOther.m_deltaNeutralClearingAccount) != 0
        || Util
            .StringCompare(m_deltaNeutralClearingIntent, l_theOther.m_deltaNeutralClearingIntent) != 0
        || Util.StringCompare(m_deltaNeutralOpenClose, l_theOther.m_deltaNeutralOpenClose) != 0
        || Util.StringCompare(m_deltaNeutralDesignatedLocation,
            l_theOther.m_deltaNeutralDesignatedLocation) != 0
    ...
    if (!Util
        .VectorEqualsUnordered(m_smartComboRoutingParams, l_theOther.m_smartComboRoutingParams)) {
      return false;
    }
