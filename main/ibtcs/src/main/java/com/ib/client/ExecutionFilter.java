...
public class ExecutionFilter {
  ...
  public ExecutionFilter(int p_clientId, String p_acctCode, String p_time, String p_symbol,
      String p_secType, String p_exchange, String p_side) {
    ...
    if (p_other == null) {
      ...
      l_bRetVal =
          (m_clientId == l_theOther.m_clientId
              ...
              && m_exchange.equalsIgnoreCase(l_theOther.m_exchange) && m_side
              .equalsIgnoreCase(l_theOther.m_side));
    }
    return l_bRetVal;
  }
}
