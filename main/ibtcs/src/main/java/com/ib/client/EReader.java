  ...
  protected boolean processMsg(int msgId) throws IOException {
    ...
    switch (msgId) {
      ...
      case TICK_OPTION_COMPUTATION: {
        ...
        eWrapper().tickOptionComputation(tickerId, tickType, impliedVol, delta, optPrice,
      ...
      case ORDER_STATUS: {
        ...
        eWrapper().orderStatus(id, status, filled, remaining, avgFillPrice, permId, parentId,
      ...
      case PORTFOLIO_VALUE: {
        ...
        eWrapper().updatePortfolio(contract, position, marketPrice, marketValue, averageCost,
        ...
        if (version >= 29) {
          ...
          if (comboLegsCount > 0) {
            ...
            for (int i = 0; i < comboLegsCount; ++i) {
              ...
              ComboLeg comboLeg =
                  new ComboLeg(conId, ratio, action, exchange, openClose, shortSaleSlot,
