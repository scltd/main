...
public class Bar {
  private static final SimpleDateFormat FORMAT = new SimpleDateFormat("yyyyMMdd HH:mm:ss"); // format
                                                                                            // for
                                                                                            // historical
                                                                                            // query
  ...
  public Bar(long time, double high, double low, double open, double close, double wap,
