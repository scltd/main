...
public class Formats {
  ...
  private static final SimpleDateFormat DATE_TIME = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); // format
                                                                                                 // for
                                                                                                 // display
  private static final SimpleDateFormat TIME = new SimpleDateFormat("HH:mm:ss"); // format for
                                                                                 // display
