...
public final class SQLQueries {
  ...
  public static String CONTRACT_BY_EXCHANGE_ID =
      "SELECT * FROM contracts WHERE exchange_contract_id LIKE ?;";
  public static String INSERT_TRADE =
      "INSERT into trades VALUES (?,?::uuid,?,?,?,?,?,nextval('tradenumber'),NOW());";
