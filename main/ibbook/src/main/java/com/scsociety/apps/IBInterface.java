...
public class IBInterface implements EWrapper {
  ...
  public void tickEFP(int tickerId, int tickType, double basisPoints, String formattedBasisPoints,
    ...
    log.info("tickEFP: tickerId: {}, tickType: {}, basisPoints: {}", tickerId, tickType,
        basisPoints);
  ...
  public void orderStatus(int orderId, String status, int filled, int remaining,
      ...
      String whyHeld) {
    log.info("orderStatus: orderId: {}, status: {}, filled: {}, clientId:{}", orderId, status,
        filled, clientId);
    if (status.equals("PreSubmitted") || status.equals("Submitted") || status.equals("Cancelled")) {
      _eventNotifier.handleOrderAck(orderId);
    }
  }

  public void openOrder(int orderId, Contract contract, Order order, OrderState orderState) {
    log.info("orderStatus: orderId: {}, m_conId: {}, m_action: {}, orderState:{}", orderId,
        contract.m_conId, order.m_action, orderState);
  ...
  public void updateAccountValue(String key, String value, String currency, String accountName) {
    log.info("updateAccountValue: {}, value:{}, currency:{},accountName:{}", key, value, currency,
        accountName);
  }
  ...
  public void updatePortfolio(Contract contract, int position, double marketPrice,
      ...
      String accountName) {
    log.info("updatePortfolio: {}, {}, {}, {}, {}, {}, {}, {}", contract.m_conId,
        contract.m_localSymbol, position, marketPrice, marketValue, averageCost, unrealizedPNL,
        realizedPNL);
  ...
  public void execDetails(int reqId, Contract contract, Execution execution) {
    ...
    log.trace("execDetails [{}],{} - {}@{} {}[{}]", reqId, contract.m_localSymbol,
        execution.m_cumQty, execution.m_price, execution.m_clientId, execution.m_shares);
    _eventNotifier.handleOrderFill(execution.m_orderId, execution.m_avgPrice, execution.m_shares);
