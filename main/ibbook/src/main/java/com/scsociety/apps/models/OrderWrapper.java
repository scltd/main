...
public class OrderWrapper implements Serializable {
	...
	public OrderWrapper(OrderEntryProto.Order o) {
		_state = State.INSERT;
		_orderWire = o;
	...
	public boolean isAcked() {
		return _state == State.INSERT_ACK || _state == State.MODIFY_ACK ? true
				: false;
	}
	...
	public void set_externalContract(Contract contract) {
		...
		_externalContract.m_conId = Integer.parseInt(contract
				.getExchangeContractId());
