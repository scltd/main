...
public enum AccountSummaryTag {
  ...
  // balances
  NetLiquidation, TotalCashValue, // Total cash including futures pnl
  ...
  PreviousEquityWithLoanValue, GrossPositionValue, // The sum of the absolute value of all stock and
                                                   // equity option positions
  RegTEquity, RegTMargin, SMA, // Special Memorandum Account

  // current margin
  InitMarginReq, MaintMarginReq, AvailableFunds, ExcessLiquidity, Cushion, // Excess liquidity as a
                                                                           // percentage of net
                                                                           // liquidation value
  ...
  DayTradesRemaining, // The Number of Open/Close trades one could do before Pattern Day Trading is
                      // detected; a value of "-1" means user can do unlimited day trades.
