...
public class NewContract implements Cloneable {
  ...
  private ArrayList<NewComboLeg> m_comboLegs = new ArrayList<NewComboLeg>(); // would be final
                                                                             // except for clone
  ...
  public ArrayList<NewComboLeg> comboLegs() {
    return m_comboLegs;
  }
  ...
  public NewContract(Contract c) {
    ...
    m_secId = c.m_secId;
    m_underComp =
        c.m_underComp != null ? new DeltaNeutralContract(c.m_underComp.m_conId,
            c.m_underComp.m_delta, c.m_underComp.m_price) : null;
