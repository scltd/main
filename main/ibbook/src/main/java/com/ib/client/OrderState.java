...
public class OrderState {
  ...
  OrderState(String status, String initMargin, String maintMargin, String equityWithLoan,
      double commission, double minCommission, double maxCommission, String commissionCurrency,
      String warningText) {
  ...
  public boolean equals(Object other) {
    ...
    if (m_commission != state.m_commission || m_minCommission != state.m_minCommission
